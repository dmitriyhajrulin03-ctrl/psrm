  ...
  return (
    <section className="py-fluid-sm md:py-fluid-lg bg-white overflow-x-hidden">
      <div className="container mx-auto max-w-screen-2xl px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48 2xl:px-64">
        <div className="flex flex-col md:flex-row items-center md:items-stretch justify-center md:justify-between gap-3 md:gap-6 lg:gap-8 xl:gap-10">
          {/* Левая часть - слоган */}
          <div className="flex items-center flex-shrink-0 w-full md:w-auto md:flex-1">
            <h2 className="text-[#D7120A] font-extra-condensed uppercase text-fluid-xl sm:text-fluid-2xl md:text-fluid-4xl lg:text-fluid-5xl xl:text-fluid-5xl font-bold leading-tight text-center md:text-left md:whitespace-nowrap">
              Верим в Молдову!
            </h2>
          </div>
          
          {/* Правая часть - звезда с текстом */}
          <div className="flex items-center flex-shrink-0 w-full md:w-auto md:flex-1 md:justify-end">
            <div className="bg-[#D7120A] border-2 border-white px-4 py-3 sm:px-5 sm:py-4 md:px-6 md:py-5 lg:px-8 lg:py-6 xl:px-10 xl:py-7 flex items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6 xl:gap-8 w-full md:w-auto justify-center md:justify-start" style={{ boxShadow: '0 0 0 2px #D7120A, 0 10px 15px -3px rgba(0, 0, 0, 0.1)' }}>
              {/* Звезда в обводке */}
              ...
              {/* Текст */}
              <p className="text-white font-extra-condensed uppercase text-fluid-lg sm:text-fluid-xl md:text-fluid-3xl lg:text-fluid-4xl xl:text-fluid-5xl font-bold leading-tight text-center md:text-left md:whitespace-nowrap">
